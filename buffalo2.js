/// This was my original code from cycle9
...
akuma.addEventListener("keydown", (e) => {
    switch (e.key) {
        case "ArrowLeft":
            akuma.style.left = parseInt(akuma.style.left) - moveBy + "px";
            break;
        case "ArrowRight":
            akuma.style.left = parseInt(akuma.style.left) + moveBy + "px";
            break;
        case "ArrowUp":
            akuma.style.top = parseInt(akuma.style.top) - moveBy + "px";
            break;
        case "ArrowDown":
            akuma.style.top = parseInt(akuma.style.top) + moveBy + "px";
            break;
